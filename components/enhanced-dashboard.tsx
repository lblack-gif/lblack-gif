    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-l-4 border-l-green-500 hover:shadow-lg hover:border-l-orange-500 transition-all duration-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{complianceData.section3Hours.toLocaleString()}</div>
            <div className="flex items-center mt-1">
              <span className="text-sm font-medium text-green-600">{complianceData.section3Percentage}%</span>
        ...
        <Card className="border-l-4 border-l-teal-500 hover:shadow-lg hover:border-l-orange-500 transition-all duration-200">
          ...
          <CardContent>
            ...
            <div className="flex items-center mt-1">
              <span className="text-sm font-medium text-teal-600">{complianceData.targetedSection3Percentage}%</span>
              <span className="text-xs text-gray-600 ml-1">of total hours</span>
            </div>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="text-xs text-gray-600">
                <div>
                  Section 3: {complianceData.section3Percentage}% (req: {complianceData.requiredPercentage}%)
                </div>
                <div>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="grid w-full grid-cols-5">
          <TabsTrigger
            value="overview"
            className="flex items-center gap-2 hover:bg-orange-100 hover:text-orange-600 data-[state=active]:bg-orange-500 data-[state=active]:text-white transition-colors"
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-green-600">{complianceData.section3Workers}</span>
                  </div>
                  <Progress
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-teal-600">{complianceData.targetedSection3Workers}</span>
                  </div>
                  <Progress
                  ...
                  />
                  <div className="text-xs text-gray-500">
                    {((complianceData.targetedSection3Workers / complianceData.totalWorkers) * 100).toFixed(1)}% of
                    workforce
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="compliance-tracking" className="space-y-4">
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <LineChart data={monthlyTrends}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Line type="monotone" dataKey="section3" stroke="#10b981" strokeWidth={3} name="Section 3 %" />
                  <Line
                    type="monotone"
                    dataKey="targeted"
                    stroke="#0d9488"
                  ...
                  />
                  <Line type="monotone" dataKey="required" stroke="#ef4444" strokeDasharray="5 5" name="Required %" />
                  <Line
                    type="monotone"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow duration-200">
              ...
              <CardContent>
                <div className="text-center p-4 border rounded-lg">
                  <div className="text-2xl font-bold text-green-600">{complianceData.section3Percentage}%</div>
                  <p className="text-sm text-muted-foreground">Section 3 Rate</p>
                  <div className="mt-2">
                    <Progress value={complianceData.section3Percentage} className="h-2" />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200">
              ...
              <CardContent>
                <div className="text-center p-4 border rounded-lg">
                  <div className="text-2xl font-bold text-teal-600">{complianceData.targetedSection3Percentage}%</div>
                  <p className="text-sm text-muted-foreground">Targeted Section 3 Rate</p>
                  <div className="mt-2">
                    <Progress value={complianceData.targetedSection3Percentage} className="h-2" />
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <TabsContent value="workers" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow duration-200">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-blue-600">{complianceData.totalWorkers}</div>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-green-600">{complianceData.section3Workers}</div>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-teal-600">{complianceData.targetedSection3Workers}</div>
          ...
          <Card className="hover:shadow-lg transition-shadow duration-200">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="text-center p-4 border rounded-lg hover:bg-orange-50 transition-colors duration-200">
            ...
            <CardContent>
              <div className="space-y-4">
                {contractorPerformance.map((contractor, index) => (
                  <div key={index} className="p-4 border rounded-lg hover:bg-orange-50 transition-colors duration-200">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {contractor.projects} active projects • {contractor.totalHours.toLocaleString()} total hours
                          </p>
                        </div>
                      </div>
                      <div className="flex items-center space-x-4">
